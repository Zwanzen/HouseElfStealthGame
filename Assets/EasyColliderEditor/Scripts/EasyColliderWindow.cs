...
namespace ECE
{
  ...
  public class EasyColliderWindow : EditorWindow
  {
    ...
    void OnSceneGUI(SceneView sceneView)
    {
      ...
      if (Selection.activeGameObject == ECEditor.SelectedGameObject || Selection.activeGameObject == ECEditor.AttachToObject)
      {
      ...
      if (!ECEPreferences.AllowBackgroundSelection && Selection.activeGameObject != ECEditor.SelectedGameObject && Selection.activeGameObject != ECEditor.AttachToObject && ECEditor.SelectedGameObject != null)
      {
        // is something previously selected still valid to be selected? re-select it.
        if (_lastValidSelectedGameObject != null && (_lastValidSelectedGameObject == ECEditor.SelectedGameObject || _lastValidSelectedGameObject == ECEditor.AttachToObject))
        {
