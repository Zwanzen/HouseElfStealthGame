public class FootControlStateMachine : StateMachine<FootControlStateMachine.EFootState>
{
    ...
    {
        Idle, // Used to wait before grounded again.
    ...
    private void InitializeStates()
    {
        ...
        States.Add(EFootState.Start, new FootPlantedState(_context, EFootState.Start));
        States.Add(EFootState.Stop, new FootIdleState(_context, EFootState.Stop));
